...
from .views import GenerateScanReportView, ScanJobCrashDataView, ScanJobCrashDownloadView, ScanJobListView, ScanJobLogsView, ScanJobStatusView, ScanReportViewSet, StartScanJobView, StopScanJobView, UploadBinaryView, UploadCorpusView, UploadSourceRepoView, UploadedArtifactsView
...
urlpatterns = [
    ...
    path("scan/jobs/<uuid:job_id>/logs/", ScanJobLogsView.as_view(), name="scan-job-logs"),
