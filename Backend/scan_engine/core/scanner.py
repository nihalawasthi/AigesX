...
class MLScanner:
    ...
    def load_model(self):
        ...
        model_path = self.model_dir / "aigesx_cve_model_v2.pkl"
        try:
    ...
    def train_new_model(self):
        ...
        output_model_path = self.model_dir / "vulnerability_model.joblib"
        output_model_path.parent.mkdir(parents=True, exist_ok=True)
        joblib.dump(model, output_model_path)
        self.logger.info("Model trained and saved to %s", output_model_path)
        return model
